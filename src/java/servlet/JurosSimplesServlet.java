...
public class JurosSimplesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Cálculo Juro</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h><a href='index.html'>Voltar</a></h3>");
            ...
            try{
               ...
               out.println("<h2>Valor juro= "+ juro+"<h2>");
               double tempo = Double.parseDouble(request.getParameter("tempo"));
               out.println("<h2>Tempo= "+ tempo+"<h2>");
               double vf = ((vp * juro * tempo)/100 + vp);  
            out.println("<h2>O valor final é: "+ vf +"<h2>");
            }catch(Exception ex) {
